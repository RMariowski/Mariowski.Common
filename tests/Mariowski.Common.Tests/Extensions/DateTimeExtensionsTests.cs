...
namespace Mariowski.Common.Tests.Extensions
{
    public class DateTimeExtensionsTests
    {
        ...
        public void ToUnixTimestamp_ShouldConvertDateTimeToUnixTimeStamp(int year, int month, int day, int hour,
            int minute, int second, int expected)
        {
